          ...
          <tbody>
            ...
            <tr className="bg-white border-b hover:bg-gray-50" key={index}>
              ...
              <td className="px-6 py-4">
                <img className="w-10 h-10 rounded-md" src={product?.image?.filePath} alt="There is a image" />
              </td>
              {!isWon && (
                  <>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-center flex items-center gap-3 mt-1">
                      ...
                      {isAdmin ? (
                        <NavLink to={`/api/admin/product/admin/update/${product._id}`} className="font-medium text-green">
                          <CiEdit size={25} />
                        </NavLink>
                      ) : (
                        <NavLink to={`/api/admin/product/update/${product._id}`} className="font-medium text-green">
                          <CiEdit size={25} />
                        </NavLink>
                      )}
                      {!isAdmin && (
